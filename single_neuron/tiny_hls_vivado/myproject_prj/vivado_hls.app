<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="myproject_prj" top="nn_top">
    <includePaths/>
    <libraryFlag/>
    <files>
        ...
        <file name="firmware/nn_top.cpp" sc="0" tb="false" cflags="-std=c++0x" csimflags="" blackbox="false"/>
    </files>
    <solutions>
